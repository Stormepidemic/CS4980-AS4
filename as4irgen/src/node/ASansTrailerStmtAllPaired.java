...
public final class ASansTrailerStmtAllPaired extends PStmtAllPaired
{
    private PSimpleStmt _simpleStmt_;

    public ASansTrailerStmtAllPaired()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ASansTrailerStmtAllPaired(
    ...
    {
        ((Analysis) sw).caseASansTrailerStmtAllPaired(this);
    }
